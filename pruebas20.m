function[corr1,impostores] = pruebas20()

[tm1,sig1,fs1] = rdmat('112m'); 
...
[tm106,sig106,fs106] = rdmat('slp41m');
[tm107,sig107,fs107] = rdmat('slp37m');
[tm108,sig108,fs108] = rdmat('190m');
...
[tm113,sig113,fs113] = rdmat('slp32m');
