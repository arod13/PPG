function [corr1,impostores] = pruebas42()
[tm1,sig1,fs1] = rdmat('1503m'); 
...
[tm33,sig33,fs33] = rdmat('163m');
[tm34,sig34,fs34] = rdmat('164m');
[tm35,sig35,fs35] = rdmat('165m');
[tm36,sig36,fs36] = rdmat('166m');
[tm37,sig37,fs37] = rdmat('190m');
...
[tm144,sig144,fs144] = rdmat('1169m');
...
%[EER, confInterEER, OP, confInterOP,th]=EER_DET_conf(corr1,impostores,0,10000);